...
public class SpecialUser extends User {
	...
	public void showInfo() {
		System.out.printf("User [userId:%s, userPw:%s, userName:%s, userGrade:%s, userAge:%d, point:%d]", super.getUserId(), super.getUserPw(), super.getUserName(), super.getUserGrade(), super.getUserAge(), point);
	}
